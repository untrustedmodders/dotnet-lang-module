...
public static class NativeMethods
{
	...
	[DllImport(DllName)]
	public static extern nint CreateVectorBool([MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.I1)] [In] bool[] arr, int len);
	...
	[DllImport(DllName)]
	public static extern void GetVectorDataBool(nint ptr, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.I1)] [In, Out] bool[] arr);
	...
	[DllImport(DllName)]
	public static extern void ConstructVectorBool(nint ptr, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.I1)] [In] bool[] arr, int len);
	...
	[DllImport(DllName)]
	public static extern void AssignVectorBool(nint ptr, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.I1)] [In] bool[] arr, int len);
