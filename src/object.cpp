...
namespace netlm {
	Object::Object(const Class& classPtr, ManagedObject managedObject)
		: _classPtr(classPtr),
	...
	void* Object::InvokeMethod(const ManagedMethod* methodPtr, void** argsVptr, void* returnValueVptr) {
		_classPtr.EnsureLoaded();
